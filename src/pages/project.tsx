        ...
        <Block strong>
          {(this.viewableUsers.size === 0) ? (
            <Block strong style={{justifyContent: "center", justifyItems: "center", position: "fixed", zIndex: 9, left: "50%", top: "50%", transform: "translate(-50%, -50%)"}}>
                <Row className="text-align-center"><Col className="text-align-center">{(this.hasNoImages) ? (<span>Bisher sind keine Medien vorhanden <br/> Beginne damit welche hochzuladen!</span>) : <span>Lade Medien...</span>}</Col></Row>
                <Row>
